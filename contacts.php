...
<body>
  ...
  <main class="main-2">
    <section class="contacts">
        <div class="container">
            <p class="contact-us center">
                Обратная связь
            </p>
            <p class="contact-us__text center">
                Найдите ответ на свой вопрос или свяжитесь с нами
            </p>
            <input type="text" class="contact-search" placeholder="Поиск">
            <div class="flex-box-2 gap">
                <img src="./assets/img/_con/Group 49.png" alt="Магазины" class="con-img">
                <img src="./assets/img/_con/Group 50.png" alt="Доставка" class="con-img">
                <img src="./assets/img/_con/Group 52.png" alt="Клуб" class="con-img">
            </div>
        </div> 
      </section>
  </main>
  ...
  <script src="assets/script/searchContact.js"></script>
