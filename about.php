...
<body>
  ...
  <main class="main">
    <section class="about">
        <div class="container">
            <h2 class="title__second center">О компании</h2>
            <article class="shops bg">
                <div class="container">
                  <div class="position-box padding">
                ...
                <div class="col-1">
                    <div class="col-1-1">
                        <div class="info">
                            ...
                            <p class="info__text">магазинов</p>
                        </div>
                        <div class="info">
                            <p class="info__count">
                                20
                            </p>
                            <p class="info__text">Скоро откроются</p>
                        </div>
                    </div>
                    <div class="col-2-2">
                        <div class="info">
                            ...
                            <p class="info__text">Основание</p>
                        </div>
                        <div class="info">
                            <p class="info__count">
                                60
                            </p>
                            <p class="info__text">В планах
                                на год</p>
                        </div>
                    </div>
                </div>
                <p class="description">
                    «Prime Market» основан в 2017 г., первый магазин торговой сети открылся в 2018 г. в Москве. В 2020 г. была представлена новая концепция торговой сети и открыт первый обновленный магазин в Санкт-Петербурге, а также стартовала масштабная программа обновления торговой сети. 
                </p>
            </div>
            <div class="flex-box-2">
                <div class="block-1">
                    <p class="title-simple">
                        Наши <span class="color-2">преимущества</span>
                    </p>
                    <ul class="about-list">
                        <li>
                            <p class="about-list__description">
                                <img src="./assets/img/list__icons/Group 32.png" alt="Приемущества" class="about-list__img">
                                Лучшие покупатели
                            </p>
                        </li>
                        <li>
                            <p class="about-list__description">
                                <img src="./assets/img/list__icons/Group 34.png" alt="Приемущества" class="about-list__img">
                                Приемлемые цены
                            </p>
                        </li>
                        <li>
                            <p class="about-list__description">
                                <img src="./assets/img/list__icons/Group 35.png" alt="Приемущества" class="about-list__img">
                                Быстрая доставка
                            </p>
                        </li>
                        <li>
                            <p class="about-list__description">
                                <img src="./assets/img/list__icons/Group 36.png" alt="Приемущества" class="about-list__img">
                ...
                <div class="block-2">
                    <p class="title-simple">
                        Наши <span class="color-3">недостатки</span>
                    </p>
                    <ul class="about-list">
                        <li>
                            <p class="about-list__description">
                                <img src="./assets/img/list__icons/1.png" alt="Приемущества" class="about-list__img">
